...
const PROVIDERS = [
  ...
  { key: () => process.env.STEP27_NVIDIA_API_KEY,         model: 'stepfun-ai/step-3.7-flash',                    fast: true,  baseUrl: NVIDIA_BASE },
  { key: () => process.env.MISTRAL_MEDIUM3_NVIDIA_API_KEY,model: process.env.MISTRAL_MEDIUM3_NVIDIA_MODEL || 'mistralai/mistral-medium-3.5-128b', fast: true, baseUrl: NVIDIA_BASE },
