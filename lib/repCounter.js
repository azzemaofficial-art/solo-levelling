...
//   punch    → pugni esplosivi (velocità estensione gomito)
// ─────────────────────────────────────────────────────────────────────────────
...
const PRESETS = {
  ...
  kicks: { joints: ['kL', 'kR'], kickVel: 500, refractMs: 700, velocity: true, label: 'Calci' },
  punch: { joints: ['eL', 'eR'], kickVel: 620, refractMs: 320, velocity: true, label: 'Pugni' },
};
...
export function createRepCounter(mode = 'squat') {
  ...
  function push(sample) {
    ...
    if (cfg.velocity) {
      // Colpi = estensione esplosiva del giunto (calci: ginocchio, pugni: gomito)
