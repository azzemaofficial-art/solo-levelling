...
export const FR_CURRICULUM = [
  ...
  { level: 'C1', color: '#3bc4a0', units: [
    { id: 'c1-01', emoji: '🏗️', title: 'Sfumature del subjonctif', topic: 'subjonctif passé, verbi di dubbio/volontà/emozione, differenza con l\'indicativo' },
    { id: 'c1-02', emoji: '🎨', title: 'Stile ed enfasi', topic: 'inversione, messa in rilievo (c\'est...que), figure retoriche di base' },
    { id: 'c1-03', emoji: '📰', title: 'Comprendere la stampa', topic: 'lessico giornalistico, titoli, sintetizzare un articolo' },
    { id: 'c1-04', emoji: '⚖️', title: 'Diritto e istituzioni', topic: 'sistema politico francese, vocabolario legale di base' },
    { id: 'c1-05', emoji: '🧬', title: 'Scienza e tecnologia', topic: 'lessico scientifico, spiegare un concetto tecnico in modo semplice' },
    { id: 'c1-06', emoji: '🎭', title: 'Ironia e sfumature', topic: 'sarcasmo, litote, understatement, capire il non detto' },
    { id: 'c1-07', emoji: '🗣️', title: 'Accenti e varietà regionali', topic: 'differenze Francia/Québec/Belgio/Svizzera, espressioni regionali' },
